DROP TABLE IF EXISTS FRIENDS,GENRE_FILM,GENRE,LIKES,REVIEWS,FILM,MPAA,EVENTS,USERS;
...
(
    ...
    CONSTRAINT LIKES_FK FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USERS (USER_ID) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT LIKES_FK_1 FOREIGN KEY (FILM_ID) REFERENCES PUBLIC.FILM (FILM_ID)  ON DELETE CASCADE ON UPDATE CASCADE
);
